...
- Then download and run the Ten Wallet extension following the instructions [here](https://docs.ten.xyz/wallet-extension/wallet-extension)
- Now connect MetaMask to the Ten testnet following the instructions [here](https://docs.ten.xyz/wallet-extension/configure-metamask)
...
You can now go ahead and deploy the contract following the instructions [here](https://docs.ten.xyz/testnet/deploying-a-smart-contract)
