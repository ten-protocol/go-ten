...
contract ObscuroERC20 is ERC20, AccessControl {
   ...
   ERC20(name, symbol)
   {
    ...
    function issueFor(address receiver, uint256 amount) external onlyRole(ADMIN_ROLE) {
        _mint(receiver, amount);
    }

    function burnFor(address giver, uint256 amount) external onlyRole(ADMIN_ROLE) {
