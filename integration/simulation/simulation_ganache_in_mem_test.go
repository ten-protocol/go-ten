...
// TestGanacheMemObscuroEthMonteCarloSimulation runs the simulation against a ganache network
...
func TestGanacheMemObscuroEthMonteCarloSimulation(t *testing.T) {
	setupTestLog()
