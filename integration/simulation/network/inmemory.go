...
func (n *basicNetworkOfInMemoryNodes) Create(params *params.SimParams, stats *stats.Stats) ([]ethclient.EthClient, []*host.Node, []*obscuroclient.Client, []string) {
	...
	for i := 0; i < params.NumberOfNodes; i++ {
		...
		obscuroClient := host.NewInMemObscuroClient(int64(i), &agg.P2p, agg.DB())
