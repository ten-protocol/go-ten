...
func (o *OutputStats) countBlockChain() {
	...
	for headBlock, found := l1Node.FetchHeadBlock(); found && !bytes.Equal(headBlock.Hash().Bytes(), common.GenesisHash.Bytes()); headBlock, _ = l1Node.BlockByHash(headBlock.ParentHash()) {
