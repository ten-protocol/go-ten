...
func createWallets(nmConfig Config, l1Client ethclient.EthClient, l2Client rpcclientlib.Client) *params.SimWallets {
	wallets := params.NewSimWallets(len(nmConfig.privateKeys), 0, nmConfig.ethereumChainID.Int64(), nmConfig.obscuroChainID.Int64())
