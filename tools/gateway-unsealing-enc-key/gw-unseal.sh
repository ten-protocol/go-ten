...
# Variables
IMAGE_NAME="testnetobscuronet.azurecr.io/obscuronet/gwunseal:latest"
CONTAINER_BASE_NAME="gateway-unsealing-enc-key"
UNIQUE_ID=$(date +%s%3N) # Using milliseconds for uniqueness
CONTAINER_NAME="${CONTAINER_BASE_NAME}-${UNIQUE_ID}"
VOLUME_NAME="TENGateway-sepolia-testnet-data"
SGX_ENCLAVE_DEVICE="/dev/sgx_enclave"
SGX_PROVISION_DEVICE="/dev/sgx_provision"
COMMAND="ego run /home/ten/go-ten/tools/gateway-unsealing-enc-key/main/main"
