...
import { ChevronLeftIcon, PanelLeft } from "lucide-react";
...
import { Sheet, SheetContent } from "@repo/ui/components/shared/sheet";
...
>(({ className, onClick, ...props }, ref) => {
  ...
  return (
    ...
    >
      <ChevronLeftIcon
        className={cn("transform duration-100 transition-transform", {
          "rotate-180": !open,
          "rotate-0": open,
        })}
      />
