...
type HeadsAfterL1BlockStorage interface {
	...
	// todo - joel - the extra param is ugly
	StoreNewHeads(l1Head common.L1RootHash, rollup *core.Rollup, receipts []*types.Receipt, isNewRollup bool, updateL1 bool) error
