...
type BlockMessageExtractor interface {
	...
	StoreCrossChainMessages(ctx context.Context, block *types.Header, processedData *common.ProcessedL1Data) error

	StoreCrossChainValueTransfers(ctx context.Context, block *types.Header, processedData *common.ProcessedL1Data) error
