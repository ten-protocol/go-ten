...
func (e *enclaveImpl) ExportCrossChainData(fromSeqNo uint64, toSeqNo uint64) (*common.ExtCrossChainBundle, common.SystemError) {
	return e.Sequencer().ExportCrossChainData(fromSeqNo, toSeqNo)
}
