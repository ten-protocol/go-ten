...
type TransactionStorage interface {
	...
	GetTransactionReceipt(ctx context.Context, txHash common.L2TxHash, requester *gethcommon.Address, syntheticTx bool) (*core.BareReceipt, error)
}
...
type ScanStorage interface {
	...
	GetTransactionsPerAddress(ctx context.Context, address *gethcommon.Address, pagination *common.QueryPagination) ([]*core.BareReceipt, error)
