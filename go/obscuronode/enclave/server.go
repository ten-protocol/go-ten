...
func StartServer(address string, nodeID common.Address, txHandler rollupcontractlib.TxHandler, validateBlocks bool, genesisJSON []byte, collector StatsCollector) error {
