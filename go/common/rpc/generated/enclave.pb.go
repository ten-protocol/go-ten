...
type BatchHeaderMsg struct {
	...
	BodyHash                      []byte           `protobuf:"bytes,6,opt,name=BodyHash,proto3" json:"BodyHash,omitempty"`
...
func (x *BatchHeaderMsg) GetBodyHash() []byte {
	if x != nil {
		return x.BodyHash
	}
	return nil
...
type RollupHeaderMsg struct {
	...
	Proof                         []byte           `protobuf:"bytes,4,opt,name=Proof,proto3" json:"Proof,omitempty"`
	Root                          []byte           `protobuf:"bytes,5,opt,name=Root,proto3" json:"Root,omitempty"`
	BatchHash                     []byte           `protobuf:"bytes,6,opt,name=BatchHash,proto3" json:"BatchHash,omitempty"`
	Number                        uint64           `protobuf:"varint,7,opt,name=Number,proto3" json:"Number,omitempty"`
	Bloom                         []byte           `protobuf:"bytes,8,opt,name=Bloom,proto3" json:"Bloom,omitempty"`
	ReceiptHash                   []byte           `protobuf:"bytes,9,opt,name=ReceiptHash,proto3" json:"ReceiptHash,omitempty"`
	Extra                         []byte           `protobuf:"bytes,10,opt,name=Extra,proto3" json:"Extra,omitempty"`
...
func (x *RollupHeaderMsg) GetBatchHash() []byte {
	if x != nil {
		return x.BatchHash
	}
	return nil
...
var file_enclave_proto_rawDesc = []byte{
	...
	0x52, 0x03, 0x74, 0x78, 0x73, 0x22, 0xae, 0x06, 0x0a, 0x0e, 0x42, 0x61, 0x74, 0x63, 0x68, 0x48,
	...
	0x18, 0x05, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x04, 0x52, 0x6f, 0x6f, 0x74, 0x12, 0x1a, 0x0a, 0x08,
	0x42, 0x6f, 0x64, 0x79, 0x48, 0x61, 0x73, 0x68, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x08,
	0x42, 0x6f, 0x64, 0x79, 0x48, 0x61, 0x73, 0x68, 0x12, 0x16, 0x0a, 0x06, 0x4e, 0x75, 0x6d, 0x62,
	...
	0x73, 0x73, 0x61, 0x67, 0x65, 0x73, 0x22, 0x70, 0x0a, 0x0c, 0x45, 0x78, 0x74, 0x52, 0x6f, 0x6c,
	...
	0x01, 0x28, 0x0c, 0x52, 0x03, 0x74, 0x78, 0x73, 0x22, 0xb1, 0x06, 0x0a, 0x0f, 0x52, 0x6f, 0x6c,
	...
	0x12, 0x1c, 0x0a, 0x09, 0x42, 0x61, 0x74, 0x63, 0x68, 0x48, 0x61, 0x73, 0x68, 0x18, 0x06, 0x20,
	0x01, 0x28, 0x0c, 0x52, 0x09, 0x42, 0x61, 0x74, 0x63, 0x68, 0x48, 0x61, 0x73, 0x68, 0x12, 0x16,
