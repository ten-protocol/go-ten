...
type BlockSubmissionResponseMsg struct {
	...
	ProducedRollup          *ExtRollupMsg            `protobuf:"bytes,1,opt,name=producedRollup,proto3" json:"producedRollup,omitempty"`
	UpdatedHeadRollup       bool                     `protobuf:"varint,2,opt,name=updatedHeadRollup,proto3" json:"updatedHeadRollup,omitempty"`
	RollupHead              *HeaderMsg               `protobuf:"bytes,3,opt,name=rollupHead,proto3" json:"rollupHead,omitempty"`
	ProducedSecretResponses []*SecretResponseMsg     `protobuf:"bytes,4,rep,name=producedSecretResponses,proto3" json:"producedSecretResponses,omitempty"`
	SubscribedLogs          []byte                   `protobuf:"bytes,5,opt,name=subscribedLogs,proto3" json:"subscribedLogs,omitempty"`
	Error                   *BlockSubmissionErrorMsg `protobuf:"bytes,6,opt,name=error,proto3" json:"error,omitempty"` // todo: avoid errors in Response objects, perhaps using gRPC Status responses
}
...
var file_enclave_proto_rawDesc = []byte{
	...
	0x61, 0x64, 0x52, 0x6f, 0x6c, 0x6c, 0x75, 0x70, 0x18, 0x02, 0x20, 0x01, 0x28, 0x08, 0x52, 0x11,
	...
	0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x14, 0x2e, 0x67, 0x65, 0x6e, 0x65, 0x72, 0x61, 0x74, 0x65,
	...
	0x65, 0x73, 0x18, 0x04, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1c, 0x2e, 0x67, 0x65, 0x6e, 0x65, 0x72,
	...
	0x73, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x0e, 0x73, 0x75, 0x62, 0x73, 0x63, 0x72, 0x69,
	0x62, 0x65, 0x64, 0x4c, 0x6f, 0x67, 0x73, 0x12, 0x38, 0x0a, 0x05, 0x65, 0x72, 0x72, 0x6f, 0x72,
	0x18, 0x06, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x22, 0x2e, 0x67, 0x65, 0x6e, 0x65, 0x72, 0x61, 0x74,
