...
func (c *Client) SubmitL1Block(ctx context.Context, blockHeader *types.Header, processedData *ethadapter.ProcessedL1Data) (*common.BlockSubmissionResponse, common.SystemError) {
