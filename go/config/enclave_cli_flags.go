...
var EnclaveFlags = map[string]*flag.TenFlag{
	...
	GasBatchExecutionLimit:        flag.NewUint64Flag(GasBatchExecutionLimit, 1e19, "The max gas executed per batch"),
	...
	GasLocalExecutionCapFlag:      flag.NewUint64Flag(GasLocalExecutionCapFlag, 1e19, "Max gas usage when executing local transactions"),
}
