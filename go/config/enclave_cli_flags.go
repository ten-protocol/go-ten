...
var EnclaveFlags = map[string]*flag.TenFlag{
	...
	GasBatchExecutionLimit:        flag.NewUint64Flag(GasBatchExecutionLimit, 2_500_000, "The max gas executed per batch"),
	...
	GasLocalExecutionCapFlag:      flag.NewUint64Flag(GasLocalExecutionCapFlag, 2_500_000, "Max gas usage when executing local transactions"),
}
