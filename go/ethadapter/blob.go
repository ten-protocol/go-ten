...
//		return fmt.Errorf("too much data to encode in one blob: len=%v", data)
//	}
//	b.Clear()
//
//	readOffset := 0
...
//			"invalid encoding version expected version %d, got %d", EncodingVersion, b[VersionOffset])
//	}
//
...
//		return nil, fmt.Errorf("invalid length for blob, got: %d", outputLen)
//	}
//
...
//		if output[i] != 0 {
//			return nil, fmt.Errorf("fe=%d: non-zero data encountered where field element should be empty", opos/32)
//		}
//	}
//	output = output[:outputLen]
//	for ; ipos < BlobSize; ipos++ {
//		if b[ipos] != 0 {
//			return nil, fmt.Errorf("pos=%d: non-zero data encountered where blob should be empty", ipos)
//		}
//	}
//	return output, nil
//}
...
//		return 0, 0, 0, fmt.Errorf("invalid field element: %d", ipos)
//	}
